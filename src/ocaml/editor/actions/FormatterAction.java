...
/**
 * This action calls the formatter on the current selection in the O'Caml editor (or all the code in the 
 * editor if nothing is selected). The formatter indents, formats comments, adjusts spaces between words...
 */
