...
public class EditorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		/*
		 * new FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAML, "oca&ml:", )); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLC, "ocaml&c:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLOPT, "ocaml&opt:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLDEP, "ocaml&dep:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLLEX, "ocamlle&x:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLYACC, "ocaml&yacc:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLDOC, "oc&amldoc:", this
		 * .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_COMPIL_PATH_OCAMLDEBUG, "ocamldebu&g:", this
		 * .getFieldEditorParent())); this.addField(new FileFieldEditor(PreferenceConstants.P_PATH_CAMLP4,
		 * "camlp4:", this .getFieldEditorParent())); this.addField(new
		 * FileFieldEditor(PreferenceConstants.P_MAKE_PATH, "make:", this .getFieldEditorParent()));
