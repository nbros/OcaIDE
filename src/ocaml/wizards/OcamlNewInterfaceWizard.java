...
public final class OcamlNewInterfaceWizard extends BasicNewResourceWizard {
	...
	public void addPages() {
		super.addPages();
		this.mainPage = new WizardNewFileCreationPage("OcamlNewInterfaceWizardPage1", this.getSelection());
		this.mainPage.setTitle("New Interface File");
		this.mainPage.setDescription("Create a new Interface File");
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		this.setWindowTitle("New Interface File");
	...
	public boolean performFinish() {
		if (!this.mainPage.getFileName().toLowerCase().endsWith(".mli"))
			this.mainPage.setFileName(this.mainPage.getFileName() + ".mli");
