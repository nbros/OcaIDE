...
public final class ImageRepository {
	...
	public static String[] all = { ICON_BINARY, ICON_BUILDALL, ICON_BYTECODE, ICON_BYTECODE, ICON_CAML16,
			...
			ICON_TEMPLATES, ICON_CLASS, ICON_EXTERNAL, ICON_OCAML_MODULE, ICON_METHOD, ICON_OBJECT, ICON_ADD,
			ICON_HELP, ICON_OCAML_MODULE_TYPE, ICON_METHOD_PRIVATE, ICON_INCLUDE, ICON_CLASS_TYPE,
			ICON_VAL_MUTABLE, ICON_FUNCTOR, ICON_RECORD_TYPE_CONSTRUCTOR, ICON_INITIALIZER, ICON_LETIN };
