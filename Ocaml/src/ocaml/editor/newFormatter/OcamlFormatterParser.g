// java -jar lib/beaver.jar -t -c src/ocaml/editor/newFormatter/OcamlFormatterParser.g
...
module_expr=
  ...
  | LPAREN.a module_expr RPAREN.b
  	{: return new Pos(a, b); :}
  | LPAREN.a VAL expr COLON package_type RPAREN.b
  	{: return new Pos(a, b); :}
;
...
structure_item=
	...
	{:
		return new Pos(a, b);
	:}
  | EXTERNAL.a val_ident COLON core_type EQUAL.c primitive_declaration.b
    {:
  ...
  | module_type.a WITH.c with_constraints.b
   	{:
    	if(b != Pos.NONE)
    		...
    		return new Pos(a, c);
   	:}
  | MODULE.a TYPE OF module_expr.b
  	{: return new Pos(a, b); :}
...
;
signature_item=
    VAL.a val_ident COLON core_type.b
    {:
    	return new Pos(a, b);
    :}
  | EXTERNAL.a val_ident COLON core_type EQUAL.e primitive_declaration.b
    {:
    	addHint(IndentHint.Type.DEF, e.getEnd() + 1, b.getEnd());
    	return new Pos(a, b);
    :}
...
class_fields=
    /* empty */
    {: return Pos.NONE; :}
  | class_fields.a INHERIT.c override_flag class_expr.d parent_binder.b
  	{:
    	if(a != Pos.NONE && b != Pos.NONE)
    		return new Pos(a, b);
    	else if(a != Pos.NONE && b == Pos.NONE)
...
;
virtual_value=
    override_flag.o MUTABLE.a VIRTUAL.c label.id COLON core_type.b
    {:
    	if(o != Pos.NONE)
    		return new Pos(o, b);
    	else if(a != Pos.NONE)
...
;
value=
    override_flag.o mutable_flag.a label.c EQUAL.e seq_expr.b
    {:
    	addHint(IndentHint.Type.DEF, e.getEnd() + 1, b.getEnd());
    	if(o != Pos.NONE)
    		return new Pos(o, b);
    		...
    		return new Pos(c, b);
    :}
  | override_flag.o mutable_flag.a label.c type_constraint EQUAL.e seq_expr.b
    {:
    	addHint(IndentHint.Type.DEF, e.getEnd() + 1, b.getEnd());
...
;
virtual_method=
    METHOD.a override_flag PRIVATE VIRTUAL label.id COLON poly_type.b
    {:
    	return new Pos(a, b);
    :}
  | METHOD.a override_flag VIRTUAL private_flag.p label.id COLON poly_type.b
    {:
    	return new Pos(a, b);
    :}
;
concrete_method =
    METHOD.a override_flag private_flag.p label.id strict_binding.b
    {:
    	return new Pos(a, b);
    :}
  | METHOD.a override_flag private_flag.p label.id COLON poly_type EQUAL.e seq_expr.b
    {:
    	addHint(IndentHint.Type.DEF, e.getEnd() + 1, b.getEnd());
    	return new Pos(a, b);
    :}
  ...
  | class_sig_fields.a VAL.c value_type.b             /*{ Pctf_val   $3 :: $1 }*/
  	{:
     	if(a != Pos.NONE)
    		...
    		return new Pos(c, b);
    :}
  | class_sig_fields.a virtual_method_type.b        /*{ Pctf_virt  $2 :: $1 }*/
  	{:
     	if(a != Pos.NONE)
    		return new Pos(a, b);
    	else
...
virtual_method_type=
    ...
    {:
    	return new Pos(a, b);
    :}
  | METHOD.a VIRTUAL private_flag label.id COLON poly_type.b
    {:
    	return new Pos(a, b);
    :}
;
...
expr=
  ...
  | LET.a MODULE UIDENT.id module_binding IN seq_expr.b
    {:
    	...
    	return new Pos(a, b);
    :}
  | LET.a OPEN mod_longident.id IN seq_expr.b
    {:
    	addHint(IndentHint.Type.IN, b.getStart(), b.getEnd());
    	return new Pos(a, b);
    :}
  ...
  | FUN.a labeled_simple_pattern fun_def.b
  	{:
  		return new Pos(a, b);
  	:}
  | FUN.a LPAREN TYPE LIDENT.id RPAREN fun_def.b
  	{:
  		return new Pos(a, b);
  	:}
...
simple_expr=
  ...
  | simple_expr.a DOT label_longident.b
    {: return new Pos(a, b); :}
  | mod_longident.a DOT LPAREN seq_expr RPAREN.b
    {: return new Pos(a, b); :}
  ...
  | simple_expr.a SHARP label.b
    {: return new Pos(a, b); :}
  | LPAREN.a MODULE module_expr COLON package_type RPAREN.b
    {: return new Pos(a, b); :}
;
...
let_binding=
    ...
    {:
    	return new Pos(a, b);
    :}
  | val_ident.a COLON typevar_list DOT core_type EQUAL seq_expr.b
    {:
    	return new Pos(a, b);
    :}
...
strict_binding=
  ...
  | labeled_simple_pattern.a fun_binding.b
  	{:
  		...
  		return new Pos(a, b);
  	:}
  | LPAREN.a TYPE LIDENT RPAREN.b fun_binding.c
  	{:
...
fun_def=
  ...
  | labeled_simple_pattern.a fun_def.b
  	{:
  		return new Pos(a, b);
  	:}
  | LPAREN.a TYPE LIDENT RPAREN.b fun_def.c
  	{:
  		addHint(IndentHint.Type.FUNARGS, a.getStart(), b.getEnd());
  		return new Pos(a, c);
  	:}
...
simple_pattern=
  ...
  | SHARP.a type_longident.b
    {: return new Pos(a, b); :}
  | LBRACE.a lbl_pattern_list.c record_pattern_end RBRACE.b
    {:
    	addHint(IndentHint.Type.RECORD, c.getStart(), c.getEnd());
    	return new Pos(a, b);
   	:}
...
record_pattern_end=
    opt_semi.a
  	{: return a; :}
  | SEMI.a UNDERSCORE.c opt_semi.b
    {:
     	if(b != Pos.NONE)
    		return new Pos(a, b);
    	else
...
with_constraint=
	...
	{:
     	if(b != Pos.NONE)
    		...
    		return new Pos(a, c);
	:}
  | TYPE.a type_parameters label_longident COLONEQUAL core_type.b
	{:
    	return new Pos(a, b);
	:}
  | MODULE.a mod_longident EQUAL.e mod_ext_longident.b
	{:
		...
		return new Pos(a, b);
	:}
  | MODULE.a mod_longident COLONEQUAL mod_ext_longident.b
	{:
		return new Pos(a, b);
	:}
;
...
simple_core_type2=
  ...
  | LBRACKETLESS.a opt_bar row_field_list GREATER name_tag_list RBRACKET.b
	{: return new Pos(a, b); :}
  | LPAREN.a MODULE package_type RPAREN.b
	{: return new Pos(a, b); :}
;
package_type=
    mty_longident.a
	{: return a; :}
  | mty_longident.a WITH package_type_cstrs.b
	{: return new Pos(a, b); :}
;
package_type_cstr=
    TYPE.a LIDENT EQUAL core_type.b
	{: return new Pos(a, b); :}
;
package_type_cstrs=
    package_type_cstr.a
	{: return a; :}
  | package_type_cstr.a AND package_type_cstrs.b
	{: return new Pos(a, b); :}
;
row_field_list=
    row_field.a                                   /*{ [$1] }*/
...
signed_constant=
  ...
  | MINUS.a NATIVEINT.b                             /*{ Const_nativeint(Nativeint.neg $2) }*/
	{: return new Pos(a, b); :}
  | PLUS.a INT.b                                    /*{ Const_int $2 }*/
	{: return new Pos(a, b); :}
  | PLUS.a FLOAT.b                                  /*{ Const_float $2 }*/
	{: return new Pos(a, b); :}
  | PLUS.a INT32.b                                  /*{ Const_int32 $2 }*/
	{: return new Pos(a, b); :}
  | PLUS.a INT64.b                                  /*{ Const_int64 $2 }*/
	{: return new Pos(a, b); :}
  | PLUS.a NATIVEINT.b                              /*{ Const_nativeint $2 }*/
	{: return new Pos(a, b); :}
;
