...
public class OcamlbuildProjectProperties extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		lblTargets
				.setToolTipText("Set the name of the targets you want to build (ex: mymodule.byte, a.native, ...)");
		...
		lblLFlags
				.setToolTipText("Linker flags that must be applied while linking object files in your project.");
	...
	private void addTargetsFieldAssist() {
		new ContentProposalAdapter(txtTargets, new TextContentAdapter(),
				new OcamlbuildTargetsProposalProvider(project), null, null);
	}
			...
			protected IStatus run(IProgressMonitor monitor) {
				try {
					...
					OcamlPlugin.logError(
							"error cleaning project after changing ocamlbuild project properties", e);
				}
