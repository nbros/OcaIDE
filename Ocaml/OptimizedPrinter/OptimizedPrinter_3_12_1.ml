...
(* compile with:
camlp4 -parser Camlp4OCamlRevisedParser -parser Camlp4OCamlRevisedParserParser -parser Camlp4QuotationCommon -parser Camlp4OCamlRevisedQuotationExpander -printer Ocaml "OptimizedPrinter_3_12_1.ml" > OptimizedPrinter.mlp && ocamlc -c -I +camlp4 OptimizedPrinter.mlp
...
module Id = struct
  value name = "OcaIDE.Printers.Optimized";
